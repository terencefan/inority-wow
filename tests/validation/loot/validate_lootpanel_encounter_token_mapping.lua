...
assert((firstEncounter.loot[1] and firstEncounter.loot[1].itemID) == 9001, "expected prototype item on prototype encounter")
assert((firstEncounter.allLoot[1] and firstEncounter.allLoot[1].itemID) == 9001, "expected prototype all-loot item on prototype encounter")
assert((secondEncounter.allLoot[1] and secondEncounter.allLoot[1].itemID) == 9002, "expected jailer all-loot item on jailer encounter")
